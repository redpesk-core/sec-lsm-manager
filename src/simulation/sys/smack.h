 ...
 */
#define smack_accesses_new(handle) (printf("smack_accesses_new(%p)\n", handle), 0)
 ...
 */
#define smack_accesses_free(handle) (printf("smack_accesses_free(%p)\n", handle))
 ...
 */
#define smack_accesses_save(handle, fd) (printf("smack_accesses_save(%p, %d)\n", handle, fd), 0)
 ...
 * @return Returns 0 on success and negative on failure.
 */
#define smack_accesses_add(handle, subject, object, access_type) \
    (printf("smack_accesses_free(%p,%s,%s,%s)\n", handle, subject, object, access_type), 1)
 ...
 * @return Returns 0 on success and negative on failure.
 */
int smack_accesses_add_modify(struct smack_accesses *handle, const char *subject, const char *object,
                              const char *allow_access_type, const char *deny_access_type);
 ...
 * on failure.
 */
#define smack_new_label_from_socket(fd, label) (printf("smack_label_length(%d, %p)\n", fd, label), 10)
...
#define smack_label_length(label) (printf("smack_label_length(%s)\n", label), (label ? (int)strlen(label) : (int)0))
